...
define('STUDENT_NAME', 'Phuong Doanh Ha');
// [ACTION REQUIRED] your Student ID
define('STUDENT_ID', '104480318');
...
define('BUCKET_NAME', 'doanhbucket');
// [ACTION REQUIRED] region of the above bucket
define('REGION', 'us-east-1');
// no need to update this const
define('S3_BASE_URL','https://doanhbucket.s3.amazonaws.com/');
...
define('DB_NAME', 'DoanhDB');
// [ACTION REQUIRED] endpoint of RDS instance
define('DB_ENDPOINT', 'http://phards.ckbum6odpyq2.us-east-1.rds.amazonaws.com');
// [ACTION REQUIRED] username of your RDS instance 
define('DB_USERNAME', 'doanh');
// [ACTION REQUIRED] password of your RDS instance
define('DB_PWD', 'doanh111104');
