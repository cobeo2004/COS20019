...
define('STUDENT_NAME', 'Xuan Tuan Minh Nguyen');
// [ACTION REQUIRED] your Student ID
define('STUDENT_ID', '103819212');
// [ACTION REQUIRED] your tutorial session
define('TUTORIAL_SESSION', 'Tuesday 06:30PM');

// [ACTION REQUIRED] name of the S3 bucket that stores images
define('BUCKET_NAME', 'xnguyenbucket');
...
define('DB_NAME', 'SimonDB');
// [ACTION REQUIRED] endpoint of RDS instance
define('DB_ENDPOINT', 'xnguyendb.csdl6sdqgtlr.us-east-1.rds.amazonaws.com');
// [ACTION REQUIRED] username of your RDS instance 
define('DB_USERNAME', 'cobeo2004');
// [ACTION REQUIRED] password of your RDS instance
define('DB_PWD', 'Tuanminh2004');
...
define('DB_PHOTO_S3REFERENCE_COL_NAME', 'ref_s3');
?>
